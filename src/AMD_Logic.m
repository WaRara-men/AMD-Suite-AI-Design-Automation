% ==========================================
% Algo-Mech Designer (AMD) Suite - Logic v23.2
% REFINED PHYSICS: Efficiency & Safety Factors
% ==========================================
function [req_val, comp, catalog, b_idx, m_name, m_unit, desc_jp] = AMD_Logic(inputs, mode, project_root)
    ...
    switch mode
        ...
        case 'Lift'
            catalog = readtable(fullfile(project_root, 'data', 'Standard_Parts_Catalog.csv'));
            load = inputs(1); p_rad = inputs(2); eff = inputs(3); budget = inputs(4);
            % 🌟 FIXED: Consider Pulley Efficiency / 滑車効率を考慮
        ...
        case 'Mobile'
            catalog = readtable(fullfile(project_root, 'data', 'Standard_Parts_Catalog.csv'));
            w = inputs(1); r = inputs(2); inc = inputs(3); b = inputs(4);
        ...
        case 'Power'
            ...
            cur = inputs(1); t = inputs(2); v = inputs(3); b = inputs(4);
        ...
        case 'Bolt'
            ...
            l = inputs(1); n = inputs(2); sf = inputs(3); b = inputs(4);
            % 🌟 FIXED: Custom Safety Factor for Bolts / ネジ専用の安全率
