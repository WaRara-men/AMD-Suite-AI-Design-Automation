...
function AMD_Visuals(ax_bar, ax_3d, catalog, b_idx, mode, inputs, m_name, m_unit)
    ...
    switch mode
        ...
        case 'Power'
            ...
            title(ax_3d, 'Battery Pack (Green)', 'Color', 'w');
        case 'Bolt'
            ...
            title(ax_3d, 'Hex Bolt (Steel)', 'Color', 'w');
        case 'Lift'
            p_rad = inputs(2); [X, Y, Z] = cylinder([p_rad p_rad], 20);
            surf(ax_3d, X, Y, Z*10, 'FaceColor', [0.4 0.6 0.8], 'EdgeColor', 'none');
        case 'Mobile'
