% ==========================================
% Algo-Mech Designer (AMD) Suite - App v23.0
% ULTIMATE INTEGRATION: Fixed Labels & 3D Snaps
% ==========================================
...
function AMD_App()
    ...
    fig = uifigure('Name', 'AMD Suite v23.0 - Ultimate Integrated Suite', 'Position', [100 100 1300 750], 'Color', bg_color);
    current_lang = 'JP';

    % --- Top Bar ---
    uilabel(fig, 'Text', '💎 AMD SUITE v23.0: DESIGN ZENITH', 'FontSize', 22, 'FontWeight', 'bold', 'Position', [20 705 600 35], 'FontColor', [0.3 0.8 1.0]);
    ...
    ctrls.Arm = build_pnl(tab_arm, 'Arm', '旋回トルク計算', {'Payload [kg]', 'Length [mm]', 'Radius [mm]', 'Budget [JPY]'}, {}, [0.1 10; 50 1000; 2 50; 1000 50000], [2, 300, 10, 15000]);
    ...
    % 🎯 FIXED LABEL: "Bolt Count" instead of just "Count"
    ctrls.Bolt = build_pnl(tab_bolt, 'Bolt', 'ネジ強度計算', {'Shear Load [kg]', 'Bolt Count [本]', 'N/A', 'Budget [JPY]'}, {}, [10 1000; 1 16; 0 1; 100 5000], [200, 4, 0, 1000]);
    ...
    function run_full()
        ...
        % 🎯 PASSING AX_3D to Report for REAL SNAPSHOT
